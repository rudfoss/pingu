...
const setup = (instrumentationKey?: string): ReturnType<typeof aiSetup> =>
	ai.setup(instrumentationKey)

export const getClient = (): TelemetryClient =>
	require("applicationinsights").defaultClient // The default client does not exist before setup has been called so it must be defined like this.

export const getCorrelationData = (): ReturnType<
	typeof getCorrelationContext
> => {
